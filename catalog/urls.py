...
urlpatterns = [
    ...
    path('book_instance/create/', views.create_book_instance, name='book_instance-create'),
    path('genre/create/', views.create_genre, name='genre-create'),
    # update
    path('author/<int:pk>/update/', views.AuthorUpdate.as_view(), name='author-update'),
    path('book/<int:pk>/update/', views.BookUpdate.as_view(), name='book-update'),
    path('book_instance/<int:pk>/update/', views.BookInstanceUpdate.as_view(), name='book_instance-update'),
    path('genre/<int:pk>/update/', views.GenreUpdate.as_view(), name='genre-update'),
    # delete
    path('author/<int:pk>/delete/', views.AuthorDelete.as_view(), name='author-delete'),
    path('book/<int:pk>/delete/', views.BookDelete.as_view(), name='book-delete'),
    path('book_instance/<int:pk>/delete/', views.BookInstanceDelete.as_view(), name='book_instance-delete'),
